      ...
      <div className="flex-1 min-w-0 max-w-5xl mx-auto px-6 py-8">
        ...
        <div className="tldr">
          <p className="text-sm text-[var(--color-text)]">
            <strong>Architecture:</strong> Most use request-response; HermitClaw is continuous; Spacebot delegates.{' '}
            <strong>Memory:</strong> Three use hybrid search (RRF); two have none; HermitClaw uses 3-factor retrieval.{' '}
            <strong>Security:</strong> IronClaw leads with 5-layer defense; pi has none by design.{' '}
            <strong>Channels:</strong> PicoClaw has 10 (most), OpenClaw has 7.{' '}
